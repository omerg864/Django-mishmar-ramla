"""
Django settings for DjangoSchedule project.
...
SECRET_KEY = os.environ.get('SECRET_KEY_RAMLA')
...
ROOT_URLCONF = 'DjangoSchedule.urls'
...
WSGI_APPLICATION = 'DjangoSchedule.wsgi.application'
